...
class Main {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Utsav", 26, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Raj", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Meet", 26, 'M');
